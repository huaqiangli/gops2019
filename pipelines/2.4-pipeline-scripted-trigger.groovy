properties([parameters([string(defaultValue: 'String_param_value', description: 'a string paramenter', name: 'String_param', trim: false), booleanParam(defaultValue: true, description: 'a boolean parameter', name: 'Boolean_param'), choice(choices: 'choice1\nchoice2\nchoice3', description: 'a boolean parameter', name: 'Choice_param')]), [$class: 'ThrottleJobProperty', categories: [], limitOneJobWithMatchingParams: false, maxConcurrentPerNode: 0, maxConcurrentTotal: 0, paramsToUseForLimit: '', throttleEnabled: false, throttleOption: 'project'],pipelineTriggers([cron('H/15 * * * *')])])
